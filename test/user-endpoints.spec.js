    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'praxi', translation: 'practice' },
            { original: 'salve', translation: 'hello' },
            { original: 'casa', translation: 'house' },
            { original: 'elit', translation: 'developer' },
            { original: 'transferendum', translation: 'translate' },
            { original: 'mirabile', translation: 'amazing' },
            { original: 'canis', translation: 'dog' },
